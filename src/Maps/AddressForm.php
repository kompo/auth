...
class AddressForm extends ModalScroll
{
    ...
    public $_Title = 'ka::maps.manage-address';
    ...
    public function body()
    {
    	...
    	return [
            _CustomPlace(),
            _Columns(
                _Input('ka::maps.address-apt_or_suite')->name('apt_or_suite'),
                _Input('ka::maps.address-description')->name('description_ad'),
            ),
            _Columns(
                _Checkbox('ka::maps.is_main_billing')->name('is_main_billing', false)->default($isMainBilling),
                _Checkbox('ka::maps.is_main_shipping')->name('is_main_shipping', false)->default($isMainShipping),
            ),
        ];
    }
