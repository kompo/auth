...
/**
 * Test Lazy Protected Model
 *
 * A test model with LAZY field protection enabled.
 * With lazy protection, sensitive fields are not removed on retrieval,
 * but instead return null when accessed.
 */
class TestLazyProtectedModel extends Model
{
    use HasFactory;
    ...
    // LAZY FIELD PROTECTION ENABLED
    protected $lazyProtectedFields = true;
